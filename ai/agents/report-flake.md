...
5. **Unknown flake, report it.** If none of the above resolved it, it's an unknown flake worth reporting. Compose the post (next section) and, in `post` mode, send it.
